jQuery(document).ready(function($){
	...
	var animationDelay = 3500,
		...
		lettersDelay = 800,
		//type effect
		typeLettersDelay = 50, //150
		selectionDuration = 500,
		typeAnimationDelay = selectionDuration + 100, //800
		//clip effect 
		revealDuration = 300, //600
		revealAnimationDelay = 1000; //1500
	...
	function showLetter($letter, $word, $bool, $duration) {
		...
		if(!$letter.is(':last-child')) { 
			...
			if($word.parents('.cd-headline').hasClass('type')) { setTimeout(function(){ $word.parents('.cd-words-wrapper').addClass('waiting'); }, -200);} //200
