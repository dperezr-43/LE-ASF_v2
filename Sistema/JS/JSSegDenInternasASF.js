...
function abreCambio( _psFolio, _plLlaveInternaASF )
{
    try
    {
        $( "#lblFolio" ).text( "Folio: " + _psFolio );
        $( "#hLlaveInternaASF" ).val( _plLlaveInternaASF );
        $( "#dvCambioEst" ).dialog( {
            resizable: false,
            height: "auto",
            width: "auto",
...
function traeSubEdos( _plLlaveEdo )
{
    try
    {
        ...
        $.ajax( {
            type: "POST",
            url: "SegDenInternasASF.aspx/AJAX_traeSubEdos",
            data: _oData,
            contentType: "application/json; charset=utf-8",
            dataType: "json"
        } )
...
function abreDoctos( _plLlaveInternaASF, _psFolio )
{
    try
    {
        //Cargamos documentos
        ...
        $( "#dDocsDenuncia" ).append( $( "<iframe />" ).attr( "src", "DoctosInterna.aspx?_psFolio=" + _psFolio + "&_plLlaveInternaASF=" + _plLlaveInternaASF ).width( "800px" ).height( "300px" ) ).dialog(
        {
            resizable: false,
            height: "auto",
            width: "900px",
                                ...
                                buttons:
                                    {
                                        "Si": function ()
                                        {
                                            _oData = "{ _psMensaje: '" + tinymce.activeEditor.getContent() + "'" +
                                            ...
                                            $.ajax( {
                                                type: "POST",
                                                url: "SegDenInternasASF.aspx/AJAX_enviaMail",
                                                data: _oData,
                                                contentType: "application/json; charset=utf-8",
                                                dataType: "json"
                                            } )
