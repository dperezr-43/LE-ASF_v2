    ...
    var Grid = function ( element, options )
{
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "Sin paginado",
            infos: "Mostrando {{ctx.start}} - {{ctx.end}} / {{ctx.total}} registros",
            loading: "Cargando...",
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <input title=\"Puede buscar por nombre, por puesto o por &aacute;rea.\" type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
