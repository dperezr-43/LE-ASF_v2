...
function validaPrimSecc()
{
    try
    {
        ...
        if ( $( "#txtNombCC" ).val() == "" )
        {
            MensajeError( "Debe capturar el nombre del Comité Comunitario o de la obra al cual pertenece el denunciante." );
            $( "#txtNombCC" ).css( "border-color", "red" );
            Recaptcha.reload();
            return false;
        }

        $( "#txtNombCC" ).css( "border-color", "" );
...
function guardaDenuncia()
{
    ...
    try
    {
        ...
        if ( $( "#txtObra" ).val() == "" )
        {
            MensajeError( "Debe capturar la obra o acción respecto de la cual se presenta la queja, denuncia o sugerencia." );
            $( "#txtObra" ).css( "border-color", "red" );
            Recaptcha.reload();
            return false;
        }
        ...
        if ( !$( "#chkEjecutandose" ).prop( "checked" ) && ( $( "#txtFechaObra1" ).val() == "" && $( "#txtFechaObra2" ).val() == "" ) )
        {
            MensajeError( "Debe capturar el periodo estimado en el que se ejecutó la obra, o en su caso, detallar si se está ejecutando." );
            $( "#txtFechaObra1" ).css( "border-color", "red" );
            $( "#txtFechaObra2" ).css( "border-color", "red" );
            $( "#chkEjecutandose" ).css( "border-color", "red" );
            Recaptcha.reload();
            return false;
        }
        ...
        $( "#txtObra" ).css( "border-color", "" );
        $( "input[id*=rdEstObra]" ).css( "border-color", "" );
        $( "#txtFechaObra1" ).css( "border-color", "" );
        $( "#txtFechaObra2" ).css( "border-color", "" );
        $( "#chkEjecutandose" ).css( "border-color", "" );
        ...
        $.ajax( {
            type: "POST",
            url: "CFISM.aspx/AJAX_verificaReCaptcha",
            data: _oData,
        ...
        .done( function ( data, textStatus, jqXHR )
        {
            ...
            if ( _aResp[1] == "True" )
            {
                ...
                _oData = "{ _psNombreObra: '" + $( "#txtNombCC" ).val() + "' " +
                            ...
                            ", _psObraAccion: '" + $( "#txtObra" ).val() + "' " +
                            ", _psEdoObra: '" + $( "input[id*=rdEstObra]:checked" ).parent().text() + "' " +
                            ", _psFechaEjecObra1: '" + $( "#txtFechaObra1" ).val() + "' " +
                            ", _psFechaEjecObra2: '" + $( "#txtFechaObra2" ).val() + "' " +
                ...
                $.ajax( {
                    type: "POST",
                    url: "CFISM.aspx/AJAX_guardaDenuncia",
                    data: _oData,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json"
                } )
