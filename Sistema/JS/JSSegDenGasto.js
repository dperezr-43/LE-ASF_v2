...
function asignaFolio( _psFolio)
{
    ...
    //$( "#hRubroRep" ).val( _psRubro );
    return true;
}
function abreCambio( _psFolio, _plLlaveGasto, _psRubro )
{
    try
    {
        $( "#lblFolio" ).text( "Folio: " + _psFolio );
        $( "#hLlaveGasto" ).val( _plLlaveGasto );
        $( "#hRubro" ).val( _psRubro );
        $( "#dvCambioEst" ).dialog( {
            resizable: false,
            height: "auto",
...
function traeSubEdos( _plLlaveEdo )
{
    try
    {
        ...
        $.ajax( {
            type: "POST",
            url: "SegDenGasto.aspx/AJAX_traeSubEdos",
            data: _oData,
                                ...
                                buttons:
                                    {
                                        "Si": function ()
                                        {
                                            ...
                                            $.ajax( {
                                                type: "POST",
                                                url: "SegDenGasto.aspx/AJAX_enviaMail",
                                                data: _oData,
                                                contentType: "application/json; charset=utf-8",
                                                dataType: "json"
                                            } )
...
function cambiaEstatus()
{
    try
    {
        ...
        {
            _oData = "{ _plLlaveGasto: " + $( "#hLlaveGasto" ).val() +
            ...
            $.ajax( {
                type: "POST",
                url: "SegDenGasto.aspx/AJAX_cambiaEstatus",
                data: _oData,
                contentType: "application/json; charset=utf-8",
                dataType: "json"
            } )
...
function abreDoctos( _plLlaveGasto, _psFolio, _psRubro )
{
    try
    {
        //Cargamos documentos
        ...
        $( "#dDocsDenuncia" ).append( $( "<iframe />" ).attr( "src", "DoctosGasto.aspx?_psFolio=" + _psFolio + "&_plLlaveGasto=" + _plLlaveGasto + "&_psRubro=" + _psRubro ).width( "800px" ).height( "300px" ) ).dialog(
        {
            resizable: false,
            height: "auto",
            width: "900px",
